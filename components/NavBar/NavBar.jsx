            ...
            <div>
              ...
              {openNav && (
                <div className={Style.navigation}>
                  ...
                  <p>
                    <Link href={{pathname: 'candidate-regisration'}}> Candidate Reg</Link>
                  </p>
                  <p>
                    <Link href={{pathname: 'allowed-voters'}}>Voter Reg</Link>
                  </p>
                  <p>
                    <Link href={{pathname: 'voterList'}}> Voter List</Link>
                  </p>
                  <p>
                    <Link href={{pathname: 'addelection'}}> Create ELection</Link>
                  </p>
                </div>
              )}
            </div>
